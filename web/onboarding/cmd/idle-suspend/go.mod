module github.com/emai-ai/swarm-onboarding/cmd/idle-suspend
...
require (
	...
	github.com/emai-ai/swarm/pkg/userspg v0.0.0-00010101000000-000000000000
...
// without published versions. Same pattern as cmd/gdpr-purge/go.mod.
