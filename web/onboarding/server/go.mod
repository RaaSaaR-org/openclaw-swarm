module github.com/emai-ai/swarm-onboarding
...
// Sibling pkg/ modules in this repo; resolve via local replace so the Docker
// build (with repo root as context) can find them without published versions.
// Same multi-module pattern as web/customer-{chat,center}/server.
